!(function () {
        ...
        (e = function () {
                ...
                if (o) {
                    var r = document.createDocumentFragment(),
                        n =
                            ...
                            o.getAttribute('viewBox');
                    n && e.setAttribute('viewBox', n);
                    for (var i = o.cloneNode(!0); i.childNodes.length; )
            ...
            function e(e) {
                (e.onreadystatechange = function () {
                    if (4 === e.readyState) {
                        var o = e._cachedDocument;
                        o ||
                            (((o = e._cachedDocument = document.implementation.createHTMLDocument(
                                ''
                            )).body.innerHTML = e.responseText),
                            (e._cachedTarget = {})),
                            e._embeds.splice(0).map(function (r) {
                                var n = e._cachedTarget[r.id];
                                n ||
                                    (n = e._cachedTarget[
                                        r.id
                    ...
                    (function r() {
                        for (var s = 0; s < f.length; ) {
                            ...
                            if (
                                (!p &&
                                    i.attributeName &&
                                    (p = u.getAttribute(i.attributeName)),
                                d && p)
                            ) {
                                if (n)
                                    if (!i.validate || i.validate(p, d, u)) {
                                        h.removeChild(u);
                                        var y = p.split('#'),
                                            m = y.shift(),
                                            v = y.join('#');
                                        if (m.length) {
                                            ...
                                            t(h, d, document.getElementById(v));
                                    } else ++s, ++c;
                            } else ++s;
                        }
                        (!f.length || f.length - c > 0) && l(r, 67);
                    })();
            };
        }),
    ...
    var h =
            ...
            (void 0 !== h && h),
        d = 'URLSearchParams' in h,
        p = 'Symbol' in h && 'iterator' in Symbol,
        y =
            'FileReader' in h &&
            'Blob' in h &&
            (function () {
    ...
    if (v)
        var b = [
            ...
            g =
                ...
                function (t) {
                    return (
                        t && b.indexOf(Object.prototype.toString.call(t)) > -1
                    );
                };
    function _(t) {
        if (
            ...
            (this._initBody = function (t) {
                ...
                (this.bodyUsed = this.bodyUsed),
                    ...
                    t
                        ? 'string' == typeof t
                            ? (this._bodyText = t)
                            : y && Blob.prototype.isPrototypeOf(t)
                            ? (this._bodyBlob = t)
                            : m && FormData.prototype.isPrototypeOf(t)
                            ? (this._bodyFormData = t)
                            : d && URLSearchParams.prototype.isPrototypeOf(t)
                            ? (this._bodyText = t.toString())
                            : v &&
                              y &&
                              (e = t) &&
                              DataView.prototype.isPrototypeOf(e)
                            ? ((this._bodyArrayBuffer = O(t.buffer)),
                              (this._bodyInit = new Blob([
                                  this._bodyArrayBuffer,
                              ])))
                            : v &&
                              (ArrayBuffer.prototype.isPrototypeOf(t) || g(t))
                            ? (this._bodyArrayBuffer = O(t))
    ...
    (E.prototype.append = function (t, e) {
        ...
        p && (E.prototype[Symbol.iterator] = E.prototype.entries);
    ...
    function j(t, e) {
        ...
        if (t instanceof j) {
            ...
            (this.url = t.url),
                ...
                e.headers || (this.headers = new E(t.headers)),
        ...
        if (
            ...
            (!e.headers && this.headers) || (this.headers = new E(e.headers)),
            (this.method =
    ...
    function F(t, e) {
        return new Promise(function (o, r) {
            ...
            (i.onload = function () {
                ...
                !e || 'object' != typeof e.headers || e.headers instanceof E
                    ...
                    : Object.getOwnPropertyNames(e.headers).forEach(function (
                          ...
                          i.setRequestHeader(t, w(e.headers[t]));
                      }),
                n.signal &&
                    (n.signal.addEventListener('abort', s),
                    (i.onreadystatechange = function () {
                        4 === i.readyState &&
                            n.signal.removeEventListener('abort', s);
                    })),
    ...
    (F.polyfill = !0),
        h.fetch ||
            ((h.fetch = F), (h.Headers = E), (h.Request = j), (h.Response = S)),
        (function () {
            function t() {
                var t = window,
                    e = document;
                ...
                function d(e) {
                    var o,
                        ...
                        a = (i() - e.startTime) / 468;
                    (s = a = a > 1 ? 1 : a),
                        (o = 0.5 * (1 - Math.cos(Math.PI * s))),
                        (r = e.startX + (e.x - e.startX) * o),
                        (n = e.startY + (e.y - e.startY) * o),
            ...
            var d = (function () {
                    function r(t) {
                        ...
                        if (
                            ...
                            throw new Error(
                                'Stickyfill is already applied to this node'
                            );
                        (this._node = t),
                                ...
                                value: function () {
                                    if (!n && !this._removed) {
                                        ...
                                        if (
                                            ...
                                            this._limits = {
                                                start:
                                                    d.top + t.pageYOffset - m,
                                                end:
                                                    p.top +
                                                    t.pageYOffset +
                                                    f.offsetHeight -
                                                    u(y.borderBottomWidth) -
                                                    o.offsetHeight -
                                                    m -
                                                    u(i.marginBottom),
                                            };
                                            ...
                                            (b.node = e.createElement('div')),
                                                ...
                                                l.insertBefore(b.node, o),
                                                (b.docOffsetTop = h(b.node));
                                        }
                                    }
                                },
                            },
                        ...
                        n
                            ? (e[r] || a(),
                              e.addEventListener(n, function () {
                                  e[r] ? clearInterval(o) : a();
                              }))
                            : a();
                }
                function i() {
                    t.pageXOffset != l.left
                        ? ((l.top = t.pageYOffset),
                          (l.left = t.pageXOffset),
                          p.refreshAll())
                        : t.pageYOffset != l.top &&
                          ((l.top = t.pageYOffset),
                          (l.left = t.pageXOffset),

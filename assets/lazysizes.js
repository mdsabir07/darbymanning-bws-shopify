        ...
        (a._lazysizesParentFit = b.fit),
            ...
            c.rAF(function () {
                ...
                'PICTURE' == e.nodeName.toUpperCase() &&
                    ...
                    g.getAttribute(f.srcsetAttr) &&
                        g.setAttribute(f.srcsetAttr, ''),
                ...
                if (a.detail.instance == c) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            for (
                                l = k.getElementsByTagName('source'),
                                    m = 0,
                                    o = l.length;
                                m < o;
                                m++
        ...
        var d = function (a, b) {
            ...
            f = function (a, b) {
                ...
                return (
                    !a._lazyrias &&
                        c.pWS &&
                        (d = c.pWS(a.getAttribute(i.srcsetAttr || '')))
                            .length &&
            ...
            j = function (d) {
                if (d.detail.instance == c) {
                    ...
                    if (
                        !u &&
                        (a.respimage || a.picturefill || lazySizesConfig.pf)
                    )
                    ...
                    var b,
                        ...
                        j = {
                            fit:
                                ...
                                a.getAttribute('data-parent-fit'),
                        };
                    return (
                ...
                getImageRatio: function (b) {
                    ...
                    for (c = 0; c < m.length; c++)
                        if (
                            ...
                            e &&
                                (!f ||
                                    ((a.matchMedia && matchMedia(f)) || {})
                                        .matches))
                        ) {
                            (h = parseFloat(
                                b.getAttribute('data-aspectratio')
                            )),
                                h ||
                                    ((i = e.match(d)),
                                    i
        ...
        i = (function () {
            ...
            return function () {
                var e = b.createElement('img'),
                    ...
                    i = function () {
                        e.currentSrc &&
                            b.removeEventListener('lazybeforeunveil', g);
                    };
            ...
            var f = function (a, b) {
                ...
                m = function (b, d) {
                    var f,
                        g =
                            b.getAttribute('srcset') ||
                            b.getAttribute(e.srcsetAttr);
                    !g &&
                        d &&
                        (g = b._lazypolyfill
                            ? b._lazypolyfill._set
                            : b.getAttribute(e.srcAttr) ||
                              b.getAttribute('src')),
                        (b._lazypolyfill && b._lazypolyfill._set == g) ||
                            ...
                            d &&
                                ...
                                ((f.isPicture =
                                    'PICTURE' ==
                                    b.parentNode.nodeName.toUpperCase()),
                                f.isPicture &&
                                    a.matchMedia &&
            ...
            l = function (a, b) {
                if (b) {
                    ...
                    c && c[1]
                        ...
                        : a.setAttribute(
                              'media',
                              lazySizesConfig.customMedia[b] || b
                          );
                }
            },
            m = function (a, c, g) {
